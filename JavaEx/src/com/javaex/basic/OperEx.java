...
//		// 만약 -> 정수를 0으로 나누면
//		
//		System.out.println("정수르 나누기 0 => " + (a / 0));
		...
		// 연산 -> 계산활 수 없는 값(NaN -> Not a Number)
		System.out.println("0.0 / 0.0 => " + (0.0 / 0.0));
		// Nan 포함된 산술 연산 -> NaN (계산 불가)
		System.out.println("0.0 / 0.0 => " + (0.0 / 0.0 + 20));
	...
	public static void incDecOper() {
		...
		System.out.println(a++); // 끝난 다음에 증가
		System.out.println(a);
		
		// 전위 연산자
		System.out.println(b); 
		System.out.println(++b); // 증가하고 증가내용 반영
		System.out.println(b);
	}
	...
	//3항 연산자
		public static void conditionalOper() {
			...
			System.out.println("시험 결과:"+message); // 그런데 이런 코드는 너무 복잡해서 현장에서는 비추천
		}
	}
